...
- <span class="svg-icon">{% include lucide-icon-github.svg %}</span> [opatry/h2go](https://github.com/opatry/h2go)
- <span class="svg-icon">{% include lucide-icon-twitter.svg %}</span> [o_patry](https://twitter.com/opatry)
- <span class="svg-icon">{% include lucide-icon-shield-check.svg %}</span> [Privacy Policy]({% link legal/privacy-policy.md %})
